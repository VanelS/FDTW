...
/*
* Calcul la distance entre deux s̩ries temporelles repr̩sent̩es sous le format PAA
*  - x1 : est une s̩rie temporelle
*  - x2 : est une s̩rie temporelle
*  - n : taille des s̩ries temporelles t1 et t2 d'ou sont calcul̩ les repr̩sentations x1 et x2
*  - W : Nombre de segments de la repr̩sentation PAA
